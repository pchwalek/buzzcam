...
#define LORA_SEND_INTERVAL_MINS 3
#define GPS_FIX_INTERVAL_MULTIPLE_OF_LORA (1)
#define GPS_FIX_INTERVAL_MINS	(LORA_SEND_INTERVAL_MINS * GPS_FIX_INTERVAL_MULTIPLE_OF_LORA)
