...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA8     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = BATT_VLTGA8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BATT_VLTGA8_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA8     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(BATT_VLTGA8_GPIO_Port, BATT_VLTGA8_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA0     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = RED_LED_Pin|BLUE_LED_Pin|GREEN_LED_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* SAI1 */
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = BATT_VLTG_Pin|GPIO_PIN_12;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
...
/* SAI1 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, BATT_VLTG_Pin|GPIO_PIN_12);
