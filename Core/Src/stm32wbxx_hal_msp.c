...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = BATT_VLTG_Pin;
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOB, BLUE_LED_Pin|RED_LED_Pin);

    HAL_GPIO_DeInit(GREEN_LED_GPIO_Port, GREEN_LED_Pin);
...
/* SAI1 */
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = SAI_SCK_A_Pin|GPIO_PIN_12;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
...
/* SAI1 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, SAI_SCK_A_Pin|GPIO_PIN_12);
