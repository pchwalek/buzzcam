...
typedef struct system_info_packet {
    ...
    bool has_buzz_interval_data;
    buzz_interval_data_t buzz_interval_data;
...
typedef struct lo_ra_packet {
    ...
    pb_size_t which_payload;
    union {
        system_summary_packet_t system_summary_packet;
    } payload;
    bool has_radio_power;
    radio_power_t radio_power;
} lo_ra_packet_t;
...
#define SYSTEM_INFO_PACKET_INIT_ZERO             {false, SIMPLE_SENSOR_READING_INIT_ZERO, 0, false, SD_CARD_STATE_INIT_ZERO, false, MARK_STATE_INIT_ZERO, false, BATTERY_STATE_INIT_ZERO, 0, {DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO, DEVICE_INIT_ZERO}, false, LOCATION_INIT_ZERO, false, BUZZ_INTERVAL_DATA_INIT_ZERO, false, BUZZ_SUMMARY_DATA_INIT_ZERO, false, RADIO_POWER_INIT_ZERO}
...
#define RADIO_POWER_RSSI_TAG                     1
#define RADIO_POWER_SNR_TAG                      2
#define RADIO_POWER_RSSI_EST_TAG                 3
...
#define BUZZ_SUMMARY_DATA_BUZZ_COUNTER_TAG       2
#define BUZZ_SUMMARY_DATA_SPECIES_1_COUNT_TAG    3
#define BUZZ_SUMMARY_DATA_SPECIES_2_COUNT_TAG    4
#define BUZZ_SUMMARY_DATA_LAST_DETECTION_EPOCH_TAG 5
...
#define LOCATION_LON_TAG                         2
#define LOCATION_ELEV_TAG                        3
...
#define SYSTEM_INFO_PACKET_BUZZ_INTERVAL_DATA_TAG 8
#define SYSTEM_INFO_PACKET_BUZZ_SUMMARY_DATA_TAG 9
#define SYSTEM_INFO_PACKET_RADIO_POWER_TAG       10
#define SYSTEM_SUMMARY_PACKET_CLASSIFIER_VERSION_TAG 1
#define SYSTEM_SUMMARY_PACKET_LOCATION_TAG       2
#define SYSTEM_SUMMARY_PACKET_BUZZ_INTERVAL_DATA_TAG 3
...
X(a, STATIC,   OPTIONAL, MESSAGE,  buzz_interval_data,   8) \
X(a, STATIC,   OPTIONAL, MESSAGE,  buzz_summary_data,   9) \
X(a, STATIC,   OPTIONAL, MESSAGE,  radio_power,      10)
...
#define system_info_packet_t_buzz_interval_data_MSGTYPE buzz_interval_data_t
#define system_info_packet_t_buzz_summary_data_MSGTYPE buzz_summary_data_t
#define system_info_packet_t_radio_power_MSGTYPE radio_power_t
...
X(a, STATIC,   SINGULAR, FLOAT,    elev,              3)
...
X(a, STATIC,   OPTIONAL, MESSAGE,  buzz_interval_data,   3) \
...
#define system_summary_packet_t_buzz_interval_data_MSGTYPE buzz_interval_data_t
...
X(a, STATIC,   OPTIONAL, MESSAGE,  header,            1) \
X(a, STATIC,   ONEOF,    MESSAGE,  (payload,system_summary_packet,payload.system_summary_packet),   2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  radio_power,       3)
#define LO_RA_PACKET_CALLBACK NULL
#define LO_RA_PACKET_DEFAULT NULL
#define lo_ra_packet_t_header_MSGTYPE packet_header_t
#define lo_ra_packet_t_payload_system_summary_packet_MSGTYPE system_summary_packet_t
#define lo_ra_packet_t_radio_power_MSGTYPE radio_power_t
...
#define SYSTEM_INFO_PACKET_SIZE                  533
